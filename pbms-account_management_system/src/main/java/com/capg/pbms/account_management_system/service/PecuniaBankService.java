...
/**
 * The PecuniaBankService class implements for accessing PecuniaBank Management
 * System Repository
 *
...
public class PecuniaBankService implements IPecuniaBankService {
	...
	public BankAccountDetails updateCustomerContact(BankAccountDetails accDetails) throws AccountNotFoundException {
		long accNo = accDetails.getAccNumber();
	...
	public BankAccountDetails updateCustomerAddress(BankAccountDetails accDetails) throws AccountNotFoundException {
		long accNo = accDetails.getAccNumber();
