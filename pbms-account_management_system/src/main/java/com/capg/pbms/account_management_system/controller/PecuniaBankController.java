...
class PecuniaBankController {
	...
	public BankAccountDetails updateCustomerContact(@RequestBody BankAccountDetails details) throws AccountNotFoundException  {
		return service.updateCustomerContact(details);
	}
	
	@PutMapping("/updateaddress")
	public BankAccountDetails updateCustomerAddress(@RequestBody BankAccountDetails details) throws AccountNotFoundException  {
		return service.updateCustomerAddress(details);
	}
